 ...
 */
export const isValid = function isValid (mask) {
 ...
 */
export const from = function from (value) {
...
*/
export const getPenaltyN1 = function getPenaltyN1 (data) {
 ...
 * Points: N2 * (m - 1) * (n - 1)
 */
export const getPenaltyN2 = function getPenaltyN2 (data) {
  const size = data.size
  let points = 0
 ...
 */
export const getPenaltyN3 = function getPenaltyN3 (data) {
  const size = data.size
  let points = 0
  let bitsCol = 0
  let bitsRow = 0
 ...
 */
export const getPenaltyN4 = function getPenaltyN4 (data) {
  let darkCount = 0
 ...
 */
export const applyMask = function applyMask (pattern, data) {
  const size = data.size
 ...
 */
export const getBestMask = function getBestMask (data, setupFormatFunc) {
