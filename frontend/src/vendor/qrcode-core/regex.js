...
export const testKanji = function testKanji (str) {
  return TEST_KANJI.test(str)
}

export const testNumeric = function testNumeric (str) {
  return TEST_NUMERIC.test(str)
}

export const testAlphanumeric = function testAlphanumeric (str) {
